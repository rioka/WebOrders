# WebOrders — Sample online ordering system

Online ordering system in Angulas (based on official angular-seed).
...
Previously we recommended that you merge in changes to the app into your own fork of the project.
